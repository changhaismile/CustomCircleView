...
public class DialProgress extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mUnitSize = typedArray.getDimension(R.styleable.DialProgress_unitSize, 15);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(measureWidthHieght(widthMeasureSpec, mDefaultSize),
                measureWidthHieght(heightMeasureSpec, mDefaultSize));
    }
     ...
     * @return
     */
    public int measureWidthHieght(int measureSpec, int defaultSize) {
